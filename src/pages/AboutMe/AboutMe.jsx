            ...
            <section className="aboutContainer">
                ...
                <section className="textSection about background">
                    <h3>Welcome to my portfolio!</h3>
                        ...
                        <p>Having completed extensive training, I possess a robust skill set covering both front-end and back-end development. My journey from student to professional has equipped me with the tools to build complex, scalable, and responsive web applications.</p>
                        <p>My commitment to continuous learning and professional growth remains steadfast. I actively engage in expanding my expertise through advanced courses and real-world projects, focusing on areas such as efficient code practices, latest industry trends, and innovative solution development.</p>
